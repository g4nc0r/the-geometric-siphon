...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Companion paper.} Three directional properties of the residual (monotonicity in displacement, directional asymmetry in USD terms, and exit-side asymmetry) are derived and verified as Theorems~4--6 in Ryan (2026b), sharing the same Foundry verification suite.
\end{enumerate}
...
\begin{enumerate}[label=(\roman*),leftmargin=*]
    ...
    \item \textbf{Displacement.} For a rebalance recentred on the current price after the tick moves by $\delta$ from the old range midpoint, $|\Delta R/V|$ is strictly increasing in $|\delta|$ for $|\delta| \leq w/2$. A detailed proof is given as Theorem~4 in Ryan (2026b).
\end{enumerate}
\end{corollary}
...
\bibitem{ryan2026b}
Ryan, K.R.\ (2026b) `The Geometric Siphon II: Directional Properties'. Available at: \url{https://doi.org/10.2139/ssrn.6481498}.
