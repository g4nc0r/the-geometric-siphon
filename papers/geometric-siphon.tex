...
The repository is at \url{https://github.com/g4nc0r/the-geometric-siphon} (archived at \url{https://doi.org/10.5281/zenodo.19526374}). The Foundry suite reproduces all theorem verifications described in \S\ref{sec:foundry} from a clean checkout. The diffusion-event log used for the empirical analyses in \S\ref{sec:results} is available on request.
