...
\hypersetup{
  ...
  pdfauthor={K.R. Ryan},
  pdftitle={The Geometric Siphon: Existence, Equilibrium, and Directional Properties of the Residual in Concentrated Liquidity Portfolios},
  pdfsubject={Concentrated liquidity, geometric residual, directional and exit asymmetries},
  pdfkeywords={geometric residual, directional asymmetry, exit asymmetry, automated market maker, Uniswap V3, Aerodrome, DeFi mechanism design}
}
...
Existence, Equilibrium, and Directional\\[6pt]
Properties of the Residual in Concentrated\\[8pt]
Liquidity Portfolios\strut}
...
\textbf{Keywords}\hspace{0.6em}geometric residual \textperiodcentered\ directional asymmetry \textperiodcentered\ automated market maker \textperiodcentered\ Uniswap V3 \textperiodcentered\ Aerodrome \textperiodcentered\ DeFi mechanism design\\[4pt]
...
\bibitem{cartea2024}
Cartea, \'A., Drissi, F., Monga, M. ``Decentralised Finance and Automated Market Making: Predictable Loss and Optimal Liquidity Provision.'' \emph{SIAM Journal on Financial Mathematics (forthcoming)} (2024) \url{https://doi.org/10.1137/23M1602103}.
...
Milionis, J., Moallemi, C.C., Roughgarden, T. ``Automated Market Making and Arbitrage Profits in the Presence of Fees.'' \emph{Financial Cryptography and Data Security} (2024) \url{https://arxiv.org/abs/2305.14604}.
...
Willetts, M., Harrington, C. ``Pools as Portfolios: Observed arbitrage efficiency and LVR analysis of dynamic weight AMMs.'' \emph{arXiv:2602.22069} (2026) \url{https://arxiv.org/abs/2602.22069}.

\bibitem{fan2023}
Fan, Z., Marmolejo-Coss\'io, F.J., Altschuler, B., Sun, H., Wang, X., Parkes, D.C. ``Strategic Liquidity Provision in Uniswap v3.'' \emph{Proceedings of the 5th Conference on Advances in Financial Technologies (AFT 2023), LIPIcs vol.~282, Article 25} (2023) \url{https://doi.org/10.4230/LIPIcs.AFT.2023.25}.
