...
\noindent\parbox[t][8.05cm][t]{\linewidth}{%
\begin{center}
{\fontsize{25pt}{29pt}\selectfont The Geometric Siphon}\\[16pt]
{\fontsize{17pt}{18pt}\selectfont Existence, Equilibrium, and Directional Properties\\[10pt]
of the Residual in Concentrated Liquidity Portfolios\strut}
...
\textbf{Keywords}\hspace{0.6em}geometric residual \textperiodcentered\ directional asymmetry \textperiodcentered\ automated market maker \\
Uniswap V3 \textperiodcentered\ Aerodrome \textperiodcentered\ DeFi mechanism design\\[4pt]
...
\begin{tikzpicture}
\begin{axis}[
  width=0.85\linewidth, height=7.2cm,
...
\textbf{Permutation test.} The Spearman rank correlation between pre-rebalance position value and dust flow $D$ across the 33 events is $\rho = -0.614$, the sign predicted by Theorem~\ref{thm:convergence} (larger positions donate proportionally to liquidity, smaller positions absorb). Reshuffling $D$ across events while holding pre-rebalance values fixed ($B = 10\,000$ permutations) places the $95\%$ null band at $[-0.34, +0.35]$ and gives a one-sided $p$-value of $0.0002$ against $H_1: \rho < 0$.
...
Hasbrouck, J., Rivera, T.J., Saleh, F. ``An Economic Model of a Decentralized Exchange with Concentrated Liquidity.'' \emph{Management Science} \textbf{72.5} 3666--3683 (2025) \url{https://doi.org/10.1287/mnsc.2024.04510}.

\bibitem{cartea2024}
Cartea, \'A., Drissi, F., Monga, M. ``Decentralized Finance and Automated Market Making: Predictable Loss and Optimal Liquidity Provision.'' \emph{SIAM Journal on Financial Mathematics} \textbf{15.3} 931--959 (2024) \url{https://doi.org/10.1137/23M1602103}.

\bibitem{milionis2022b}
Milionis, J., Moallemi, C.C., Roughgarden, T., Zhang, A.L. ``Automated Market Making and Loss-Versus-Rebalancing.'' \emph{arXiv:2208.06046} (2024) \url{https://doi.org/10.48550/arXiv.2208.06046}.

\bibitem{milionis2024}
Milionis, J., Moallemi, C.C., Roughgarden, T. ``Automated Market Making and Arbitrage Profits in the Presence of Fees.'' In Clark, J., Shi, E. (eds.), \emph{Financial Cryptography and Data Security (FC 2024)}, Lecture Notes in Computer Science vol.~14744, Springer, Cham (2025) \url{https://doi.org/10.1007/978-3-031-78676-1_9}.
...
Willetts, M., Harrington, C. ``Pools as Portfolios: Observed arbitrage efficiency \& LVR analysis of dynamic weight AMMs.'' \emph{arXiv:2602.22069} (2026) \url{https://doi.org/10.48550/arXiv.2602.22069}.

\bibitem{fan2023}
Fan, Z., Marmolejo-Cossio, F., Moroz, D., Neuder, M., Rao, R., Parkes, D.C. ``Strategic Liquidity Provision in Uniswap V3.'' \emph{5th Conference on Advances in Financial Technologies (AFT 2023), LIPIcs vol.~282, pp.~25:1--25:22} (2023) \url{https://doi.org/10.4230/LIPIcs.AFT.2023.25}.
...
\bibitem{maverick2023}
Maverick Research Team. ``Maverick AMM.'' \emph{Maverick Protocol whitepaper, v1.0} (March 2023) \url{https://docs.mav.xyz/}.
...
I restate the key claim for convenience before giving the substitution argument for the ratio-preserving branch.
...
V_K \leq V_0(1 - \bar\alpha_K)^K.
\]
Since $1 - \alpha_k \leq 1 - \alpha_{\min}$ for all $k$, this also gives
\[
V_K \leq V_0(1 - \alpha_{\min})^K.
\]
