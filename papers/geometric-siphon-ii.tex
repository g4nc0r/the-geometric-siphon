...
\noindent The repository is at \url{https://github.com/g4nc0r/the-geometric-siphon} (archived at \url{https://doi.org/10.5281/zenodo.19526374}). The Foundry suite reproduces all theorem verifications from a clean checkout. The Phase 3 diffusion-event log used for the empirical confirmations in \S2 is available on request.
